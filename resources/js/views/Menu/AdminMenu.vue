<template>
    <div class="app-wrapper">
        ...
        <h3 class="text-center mb-5 menu-heading">Welcome Administrator!</h3>
        ...
        <router-link :to="{ name: 'menu.admin' }" class="btn mb-2 mx-auto btn-main">Add Question</router-link>
