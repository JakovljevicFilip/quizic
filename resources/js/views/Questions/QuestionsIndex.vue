...
<div class="h-100">
    ...
    <div class="d-flex flex-column container-index__scroll"  v-if="questions.length !== 0 ">
        ...
        <div class="d-flex justify-content-center mb-3">
            <div v-for="difficulty in difficulties" :key="difficulty.id" class="mx-3 text-center btn btn-main" :class="{'btn-main--active': difficulty.id === pagination.difficulty}" @click="changeDifficulty(difficulty.id)" v-tooltip.bottom="'Show '+difficulty.label+' questions'">{{ difficulty.label }}</div>
        </div>
